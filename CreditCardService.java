...
public class CreditCardService {
    ...
    public BigDecimal getAvailableCredit(Integer id) {
        ...
        BigDecimal totalPendingPayments = creditCardPaymentRepository.getTotalPendingPaymentsByCreditCard(id);
    ...
    public List<CreditCardPayment> getPaymentsByDebtId(Integer debtId) {
        return creditCardPaymentRepository.getPaymentsByDebtIdOrderedByInstallment(debtId);
    }
