...
public abstract class BaseCreditCardDebtManagement {
    ...
    @FXML protected Label crcAvailableLimitLabel;

    @FXML protected Label crcLimitAvailableAfterDebtLabel;

    @FXML protected Label msgLabel;

    @FXML protected TextField descriptionField;

    @FXML protected TextField valueField;

    @FXML protected TextField installmentsField;
    ...
    protected void loadSuggestionsFromDatabase() {
        suggestionsHandler.setSuggestions(creditCardService.getCreditCardDebtSuggestions());
    }
    ...
    protected void updateMsgLabel() {
        int installments =
                installmentsField.getText().isEmpty()
                        ? 1
    ...
    protected void configureSuggestions() {
        Function<CreditCardDebt, String> filterFunction = CreditCardDebt::getDescription;

        // Format:
        //    Description
        //    Amount | CreditCard | Category | Installments
        Function<CreditCardDebt, String> displayFunction =
                ccd ->
                        String.format(
                                "%s%n%s | %s | %s | %sx",
                                ccd.getDescription(),
        ...
        Consumer<CreditCardDebt> onSelectCallback = this::fillFieldsWithTransaction;
