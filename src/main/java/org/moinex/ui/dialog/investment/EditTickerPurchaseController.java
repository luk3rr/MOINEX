        ...
        try {
            ...
            if (purchase.getWalletTransaction().getWallet().getId().equals(wallet.getId())
                ...
                WindowUtils.showInformationDialog(
                        ...
                        preferencesService.translate(
                                TranslationKeys.INVESTMENT_DIALOG_NO_CHANGES_PURCHASE_MESSAGE));
            } else // If there is any modification, update the transaction
            {
                ...
                WindowUtils.showSuccessDialog(
                        preferencesService.translate(
                                TranslationKeys.INVESTMENT_DIALOG_PURCHASE_UPDATED_TITLE),
                        preferencesService.translate(
                                TranslationKeys.INVESTMENT_DIALOG_PURCHASE_UPDATED_MESSAGE));
            }
            ...
            WindowUtils.showErrorDialog(
                    preferencesService.translate(
                            TranslationKeys.INVESTMENT_DIALOG_ERROR_UPDATING_PURCHASE_TITLE),
                    e.getMessage());
        }
    }
}
