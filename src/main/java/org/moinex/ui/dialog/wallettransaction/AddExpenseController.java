...
public final class AddExpenseController extends BaseWalletTransactionManagement {
    ...
    protected void handleSave() {
        ...
        try {
            ...
            walletService.createWalletTransaction(new WalletTransaction(null, dateTimeWithCurrentHour, status, description, includeInAnalysisCheckBox.isSelected(), wallet, category, walletTransactionType, expenseValue));
