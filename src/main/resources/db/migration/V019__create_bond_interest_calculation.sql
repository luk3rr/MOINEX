CREATE TABLE IF NOT EXISTS bond_interest_calculation (
    ...
    monthly_interest NUMERIC(38, 2) NOT NULL,
...
CREATE INDEX idx_bond_interest_ref_month ON bond_interest_calculation(reference_month);
CREATE UNIQUE INDEX idx_bond_interest_unique ON bond_interest_calculation(bond_id, reference_month);
