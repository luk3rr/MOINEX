...
class WalletServiceTest {
    ...
    @InjectMocks private WalletService m_walletService;
    ...
    void testChangeWalletTypeDoesNotExist() {
        ...
        when(m_walletTypeRepository.existsById(m_walletType2.getId())).thenReturn(false);
    ...
    void testChangeWalletTypeSameType() {
        ...
        when(m_walletTypeRepository.existsById(m_wallet1.getType().getId())).thenReturn(true);

        assertThrows(
                MoinexException.AttributeAlreadySetException.class,
                () -> m_walletService.changeWalletType(m_wallet1.getId(), m_wallet1.getType()));
    ...
    void testUpdateWalletBalance() {
        ...
        verify(m_walletRepository).save(m_wallet1);
        assertEquals(
                newBalance.doubleValue(), m_wallet1.getBalance().doubleValue(), Constants.EPSILON);
    }
    ...
    void testUpdateWalletBalanceDoesNotExist() {
        ...
        assertThrows(
                EntityNotFoundException.class,
                () ->
                        m_walletService.updateWalletBalance(
                                m_wallet1.getId(), new BigDecimal("1000.0")));
