...
class CreditCardServiceTest {
    ...
    class UpdateCreditCardDebtTests {
        ...
        void updateCreditCardDebt_Success_AllChanges_DecreasedInstallments() {
            ...
            when(creditCardPaymentRepository.getPaymentsByDebtOrderedByInstallment(oldDebt.getId()))
    ...
    class DeleteDebtTests {
        ...
        void deletesDebtSuccessfully() {
            ...
            when(creditCardPaymentRepository.getPaymentsByDebtOrderedByInstallment(debtId)).thenReturn(payments);
        ...
        void throwsExceptionWhenPaymentDoesNotExist() {
            ...
            when(creditCardDebtRepository.findById(debtId)).thenReturn(Optional.of(debt));
            when(creditCardPaymentRepository.getPaymentsByDebtOrderedByInstallment(debtId))
    ...
    class RefundDebtTests {
        ...
        void refundDebt_Success_CreatesCredit() {
            ...
            when(creditCardPaymentRepository.getPaymentsByDebtOrderedByInstallment(debt.getId()))
                    .thenReturn(payments);
            when(creditCardRepository.findById(creditCard.getId()))
                    .thenReturn(Optional.of(creditCard));
